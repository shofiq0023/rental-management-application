...
import { LoginReqModel } from 'src/app/models/data-models/login-request.model';
import { LoginModel } from 'src/app/models/data-models/login-response.model';
...
export class LoginComponent {
  ...
  constructor(private userAuthenticationService: AuthenticationService, private snackBar: MatSnackBar, private router: Router, private localStorageService: LocalStorageService) { }
