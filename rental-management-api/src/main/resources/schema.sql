...
(
	...
	building_flat_id BIGINT NOT NULL,
	...
	CONSTRAINT fk_renter_building_flat FOREIGN KEY (building_flat_id)
        REFERENCES public.building_flat (id)
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
);
...
-- RENTERS BUILDING TABLE
CREATE TABLE IF NOT EXISTS public.renters_building
(
	id BIGINT NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
	user_id BIGINT NOT NULL,
	building_flat_id BIGINT NOT NULL,
	...
	CONSTRAINT fk_renters_building_users FOREIGN KEY(user_id)
		REFERENCES public.users (id)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION,

	CONSTRAINT fk_renters_building_building_flat FOREIGN KEY(building_flat_id)
		REFERENCES public.building_flat(id)
		ON UPDATE NO ACTION
		ON DELETE NO ACTION
);